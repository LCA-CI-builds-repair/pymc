...
#   WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express             "The following variables are not random variables in the model: " + str(notin)
        )

    return value_varsmplied.
